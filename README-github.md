...
![License](https://img.shields.io/badge/license-proprietary-141B2E)
...
<sub><b>Results</b> — circular match score, the five weighted components, and the headline stats.</sub>

</div>

|  |  |
|---|---|
| ![Landing page](docs/screenshot-landing.png) | ![Skills and gaps](docs/screenshot-skills.png) |
| **Landing** — resume left (violet), job description right (teal) | **Overlap & gaps** — matched skills sized by demand, inferred ones flagged |

<div align="center">

![How the score is calculated](docs/screenshot-methodology.png)

<sub><b>Methodology</b> — the live equation, draggable weights, and every component's working. No part of the score is hidden.</sub>

</div>

<details>
<summary>More views — keyword analysis and mobile</summary>

<br>

<div align="center">

![Keyword analysis](docs/screenshot-keywords.png)

<sub><b>Keyword analysis</b> — terms ranked by tf-idf, coloured by whether the resume contains them.</sub>

<br><br>

<img src="docs/screenshot-mobile.png" width="300" alt="CareerMatch on a phone">

<sub><b>Mobile</b> — the full dashboard at 390 px.</sub>
...
Copyright &copy; 2026 **Darel Rodriguez**. All rights reserved.

This project is published for portfolio and evaluation purposes. You're welcome to read the source
and run it locally to assess my work. Copying, modifying, redistributing, deploying or using it
commercially requires my written permission — see [LICENSE](LICENSE) for the full terms.

For licensing enquiries: [darelrodriguez1997@gmail.com](mailto:darelrodriguez1997@gmail.com)

Built by [Darel Rodriguez](https://darel-rodriguez.com) &middot;
[LinkedIn](https://www.linkedin.com/in/darel-rodriguez) &middot;
[GitHub](https://github.com/Darel1997)
